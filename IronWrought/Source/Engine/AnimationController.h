...
*	
* TODO
*	Change this into a shared object. All entities that use the same animations can share the same controller.
*	+ Create AnimationControllerFactory
*   + Separate AnimationController into h and cpp files
*   + Make AnimationComponent or Animation hold a pointer or reference to the shared controller. 
	  AnimationComponent or Animation must now hold their blend data, animation scene index (current, previous), animation time and so on.
	  (Aki has tested this and knows what needs to be kept in the controller and what doesnt, atleast most of the things. Ask him (me) for advice if needed/desired).
* 
*/ ///////////////////////////////////////////////////////////////////////// /*
